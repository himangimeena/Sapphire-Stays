...
router.get('/housekeeping', authenticate, requireRoles(['RECEPTIONIST']), async (req, res) => {
  try {
...
router.patch('/housekeeping/:id', authenticate, requireRoles(['RECEPTIONIST']), async (req, res) => {
  try {
...
router.get('/maintenance', authenticate, requireRoles(['RECEPTIONIST']), async (req, res) => {
  try {
...
router.post('/maintenance', authenticate, requireRoles(['RECEPTIONIST']), async (req, res) => {
  try {
...
router.patch('/maintenance/:id', authenticate, requireRoles(['RECEPTIONIST']), async (req, res) => {
  try {
    const { status, roomId } = req.body;
