...
export default function Branches() {
  ...
  return (
    <div className="py-10 sm:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in">
            ...
            <div key={b.id} className="glass-card overflow-hidden rounded-2xl flex flex-col justify-between border border-gray-200 dark:border-gray-800 shadow-lg hover:shadow-2xl transition">
              <div>
                ...
                <div className="p-4 sm:p-6 space-y-2 sm:space-y-3">
                  ...
                  <h3 className="font-serif text-xl sm:text-2xl font-bold">{b.name}</h3>
              ...
              <div className="p-4 sm:p-6 pt-0 flex flex-wrap items-center justify-between gap-3 border-t border-gray-100 dark:border-gray-800/50 mt-4">
                <div>
                  ...
                  <span className="font-serif font-bold text-base sm:text-lg text-[#0F3D6E] dark:text-amber-300">₹{Number(b.starting_price).toLocaleString('en-IN')}</span>
                  <span className="text-xs text-gray-400"> / night</span>
                </div>
                <Link to={`/branches/${b.id}`} className="btn-luxury !py-3 sm:!py-2.5 !px-5 text-xs shrink-0">
                  View Details
                </Link>
              </div>
            </div>
